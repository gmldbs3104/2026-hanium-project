...
> ⚠️ **낡은 사본(2026-08-19 확인)** — 이 파일은 `ai/AI_MODEL_INTERFACE.md`의 2026-06-27 시점
> 사본이며, 이후 갱신(2026-07-18 실구현 연결 등)이 반영되지 않았습니다. 최신 스펙은
> [`ai/AI_MODEL_INTERFACE.md`](ai/AI_MODEL_INTERFACE.md)를 보세요. 이 사본은 초기 계약 기록으로만 남겨둡니다.
